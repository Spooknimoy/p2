  ...
  return (
    <View style={styles.container}>
          ...
          <Card mode="outlined" style={styles.card}>
            <Card.Content style={styles.cardContent}>
              <View style={{ flex: 1 }}>
                ...
                <Text variant="bodyLarge">Fornação: {item?.formacao }</Text>
                <Text variant="bodyLarge">Matricula do professor: {item?.matricula }</Text>
      ...
      <FAB
        icon="plus"
        style={styles.fab}
        onPress={() => navigation.push('FormProfessor', { acao: adicionarCadastro })}
      />
    </View>
  );
}
